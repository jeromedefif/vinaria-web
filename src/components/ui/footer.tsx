    ...
    <footer className="bg-gray-100 mt-12 py-8" data-supportsscrollrestoration="true">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-playfair text-xl font-bold text-wine-burgundy mb-4">VINARIA s.r.o.</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/gdpr" className="font-montserrat text-sm text-gray-700 hover:text-wine-burgundy">
                  Ochrana osobních údajů
                </Link>
              </li>
              <li>
                <a href="https://www.beginy.cz" className="font-montserrat text-sm text-gray-700 hover:text-wine-burgundy" target="_blank" rel="noopener noreferrer">
                  B2B - beginy.cz
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <address className="font-montserrat text-sm text-gray-700 not-italic">
              ...
              <p>613 00 Brno</p>
              <p className="mt-2">Tel: <a href="tel:+420734720994" className="hover:text-wine-burgundy">+420 734 720 994</a></p>
              <p>Email: <a href="mailto:info@vinaria.cz" className="hover:text-wine-burgundy">info@vinaria.cz</a></p>
              <p>IČ: 26904730</p>
            </address>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="text-gray-700 hover:text-wine-burgundy" target="_blank" rel="noopener noreferrer">
                <span className="sr-only">Facebook</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://instagram.com" className="text-gray-700 hover:text-wine-burgundy" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-montserrat text-center text-sm text-gray-500 mb-4 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button
                ...
                className="font-montserrat text-sm text-gray-500 hover:text-wine-burgundy underline"
              >
                Nastavení cookies
              </button>
              <Link href="/gdpr" className="font-montserrat text-sm text-gray-500 hover:text-wine-burgundy">
